            ...
            <div>
              ...
              <div className="grid grid-cols-4 gap-2">
                {[
                  ...
                  { id: "sparkle", label: "Étincelle", svg: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2l2 7 7 1.5-7 2-2 7-2-7-7-2 7-1.5z"/><circle cx="12" cy="12" r="2" fill="currentColor" opacity=".35"/></svg>' },
                  { id: "heart", label: "Coeur", svg: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M20.8 4.6a5.5 5.5 0 0 0-7.8 0l-1 1-1-1a5.5 5.5 0 0 0-7.8 7.8l1 1L12 21.2l7.8-7.8 1-1a5.5 5.5 0 0 0 0-7.8z"/><path d="M12 8l-1-1" stroke-width="1.5"/><circle cx="12" cy="8" r="1.2" fill="currentColor"/></svg>' },
